---
title: "Alternative Bigleaf Maple Diameter Growth"
...
Removing `si` degrades the fit marginally and probably not significantly. The alternative model fits the data well given the limited data. There is a trend with latitude that seems to be significant.
