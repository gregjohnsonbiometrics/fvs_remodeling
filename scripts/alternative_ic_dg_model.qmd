---
title: "Alternative Incense Cedar Diameter Growth"
...
Removing `si` degrades the fit marginally. Otherwise, the alternative model fits the data suprisingly well given the limited data.
